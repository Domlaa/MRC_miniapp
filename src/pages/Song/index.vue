<template>
	<View class="Song">
		...
		<View class="img-box">
			<Image :class="['rotate', audio_paused ? 'paused' : '']" mode="widthFix" :src="
                    song.al.picUrl
		...
		<View class="footer">
			...
			<View class="range-box">
				...
				<slider :value="sliderValue" activeColor="#31c27c" backgroundColor="rgba(255,255,255,0.4)" blockColor="#31c27c"
				 :blockSize="14" @change="sliderChange" />
				<Text>
					{{
                        audio
			...
			<View class="btn-box">
				<Image class="switch" @click="Switch" :src="
                        mode === 1
                    ...
                    " />
				<Image :src="require('../../static/play_btn_prev.png')" @click="prev" class="prev" />

				<Image @click="turnState" :src="
                        audio_paused
                            ? require('../../static/play_btn_play.png')
                            : require('../../static/play_btn_pause.png')
                    "
				 class="play" />
				<Image :src="require('../../static/play_btn_next.png')" @click="next" class="next" />
				<Image :src="require('../../static/play_icn_src.png')" @click="show = true" class="see" />
			</View>
		</View>
